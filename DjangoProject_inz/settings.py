"""
Django settings for DjangoProject_inz project.
...
SECRET_KEY = 'django-insecure-14g0@on!f@q-cr%&rvnd%v1vy*-jpt5dy-wx8(qlm5urg)nrm_'
...
WSGI_APPLICATION = 'DjangoProject_inz.wsgi.application'
